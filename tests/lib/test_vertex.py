...
class TestAnthropicVertex:
    ...
    @pytest.mark.respx()
    def test_body_serializes_static_fields_before_messages(self, respx_mock: MockRouter) -> None:
        request_url = "https://region-aiplatform.googleapis.com/v1/projects/project/locations/region/publishers/anthropic/models/claude-3-sonnet@20240229:rawPredict"
        ...
        assert keys[0] == "anthropic_version"
        assert keys.index("system") < keys.index("max_tokens")
...
class TestAsyncAnthropicVertex:
    ...
    @pytest.mark.respx()
    async def test_body_serializes_static_fields_before_messages(self, respx_mock: MockRouter) -> None:
        request_url = "https://region-aiplatform.googleapis.com/v1/projects/project/locations/region/publishers/anthropic/models/claude-3-sonnet@20240229:rawPredict"
        respx_mock.post(request_url).mock(return_value=httpx2.Response(200, json={"foo": "bar"}))
